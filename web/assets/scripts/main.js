...
! function(t, e) { "use strict"; "function" == typeof define && define.amd ? define("jquery-bridget/jquery-bridget", ["jquery"], function(i) { e(t, i) }) : "object" == typeof module && module.exports ? module.exports = e(t, require("jquery")) : t.jQueryBridget = e(t, t.jQuery) }(window, function(t, e) { "use strict";
  ...
  function i(i, r, a) {
    ...
    function h(t, e) { t.each(function(t, n) { var o = a.data(n, i);
        o ? (o.option(e), o._init()) : (o = new r(n, e), a.data(n, i, o)) }) } a = a || e || t.jQuery, a && (r.prototype.option || (r.prototype.option = function(t) { a.isPlainObject(t) && (this.options = a.extend(!0, this.options, t)) }), a.fn[i] = function(t) { if ("string" == typeof t) { var e = o.call(arguments, 1); return u(this, t, e) } return h(this, t), this }, n(a)) }
    ...
    o = {
      adjust: function() {
        for (var i = t(".gallery"), o = 0; o < i.length; o++) {
          ...
          h || (h = 0), 800 > a && h > 15 && (h = 15), r.css({ "padding-top": h, "padding-bottom": h, "padding-left": Math.floor(h / 2), "padding-right": Math.floor(h / 2) })
          ...
          var d = r.width(),
            ...
            u = Math.floor(g * l),
            w = Math.floor(h / 2)
          f.each(function() { t(this).css({ width: c, height: g, "margin-left": w, "margin-right": w }), t(this).hasClass("h2") && a > 800 && t(this).css("height", u + h), t(this).hasClass("w2") && a > 800 && 1 != n && t(this).css("width", 2 * c + h), t(this).hasClass("full") && (t(this).css("width", d - h), "auto" != e && t(this).css("height", s)) })
          ...
          r.isotope({ itemSelector: ".entry", masonry: { columnWidth: c + h } }), t(".filters li").on("click", function() {
            var i = t(this).data("filter")
            t(".filters li").removeClass("active"), t(this).addClass("active"), r.isotope({ filter: i })
          })
        }
      }
    }
  i.on("load", function() { o.adjust() }), i.on("resize", function() { a = window.innerWidth, s = window.innerHeight, o.adjust() })
}(jQuery)

! function(n) {
  "use strict"

  function i() { n(".hero").css("height", .7 * u) }

  function e(i) { i === !0 ? n("#site-nav, #main-overlay").addClass("nav-open") : (n("#site-nav, #main-overlay").removeClass("nav-open"), setTimeout(function() { n("#menu li.has-submenu a").next(".submenu").slideUp(300) }, 500)) }

  function o() {
    n(".imageBG").each(function() {
      var i = n(this).data("img")
      n(this).css({ backgroundImage: "url(" + i + ")", backgroundSize: "cover", backgroundPosition: "center center" })
    })
  }
    ...
    s.on("scroll", function() {
      n(".reveal").each(function(i) {
        var e = n(this).offset().top,
          o = u + s.scrollTop()
        o > e && n(this).delay(100 * i).queue(function() { n(this).addClass("reveal-in") })
      })
    }), s.scroll()
  }
  var s = n(window),
  ...
  s.on("load", function() { setTimeout(function() { n("#site-loading").addClass("hide") }, 500), setTimeout(function() { t() }, 500), i(), o() }), s.on("resize", function() { a = window.innerWidth, u = window.innerHeight, i(), e(!1) }), n("#menu li:has(ul)").children("ul").hide(), n("#menu li:has(ul)").find("a").on("click", function() {
    var i = n(this).parent(),
      e = n(this).next("ul")
  ...
  }), n("#burger").on("click", function() { e(n("#site-nav").hasClass("open") ? !1 : !0) }), n("#nav-close, #main-overlay").on("click", function() { e(!1) })
}(jQuery)
